...
export default function DashbordRecyclage2({user}) {
  return (
        ...
        <div className="card-body">
            <div className="row">
                <div className="col"> <span
                        className="h6 font-semibold text-muted text-sm d-block mb-2">Fournisseurs</span>
                    <span className="h3 font-bold mb-0">{user?.trocs?.length + user?.ventes?.length === 0 ? "0": user?.trocs?.length + user?.ventes?.length}</span>
                </div>
